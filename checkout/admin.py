...
class OrderAdmin(admin.ModelAdmin):
    ...
    fields = ('order_number', 'date', 'full_name', 'emal', 'phone_number', 'country', 'postcode', 'town_or_city', 'street_address1', 'street_address2', 'region', 'delivery_cost', 'order_total', 'grand_total',)
